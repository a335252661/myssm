...
<div class="easyui-panel" title="高级功能">
    <form id="upForm" method="post" enctype="multipart/form-data" style="margin: 10px">
        ...
        <input class="easyui-filebox" data-options="prompt:'浏览'" id="contractFile1" name="contractFile"
               style="width:155px">
    </form>
...
<div class="easyui-panel" title="测试">
    <form id="form1" method="post" enctype="multipart/form-data">
        ...
        <input class="easyui-filebox" data-options="prompt:'浏览'" id="contractFile" name="contractFile"
               style="width:155px">
        <input class="easyui-filebox" data-options="prompt:'浏览'" id="invoiceFile" name="invoiceFile"
               style="width:155px">
    </form>
