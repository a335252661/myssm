...
public  class WeChatHelp {
    ...
    //bug应用的   secret
    private static String bug_secret = "v_sWaLf1a-gcNj6JsvBkTpJNVuGFbYu1QQxSlL8PZUU";
    //日志测试应用的   secret
    private static String log_secret = "qHToh622zGu94dqbI4tsGGHSeNJyyO1iOhz1Lxo3yBM";
    ...
    public static void sendCompanyWeChatMsg(String secret , String msg){
        if(WeChatHelp.access_token.equals("")){
